...
def base_plots(df_anl, df_ges, **args):
    ...
    if('u_observation' in df_anl.columns):
...
def wind_base_plots(df_anl, df_ges, **args):
    ...
    u_omf = df_anl['u_omf_adjusted']
    v_omf = df_anl['u_omf_adjusted']
